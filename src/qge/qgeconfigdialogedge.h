 ...
 ***************************************************************************/
#ifndef QGECONFIGDIALOGEDGE_H
#define QGECONFIGDIALOGEDGE_H
...
*/
class QgeConfigDialogEdge : public QgeConfigDialog{
	public:
		QgeConfigDialogEdge( QgeEdge* qgeedge, QStringList types, QWidget* parent = 0 ) ;
		~QgeConfigDialogEdge() ;
