 ...
 ***************************************************************************/
#ifndef QGECONFIGDIALOGNODE_H
#define QGECONFIGDIALOGNODE_H

#include <qgeconfigdialog.h>

class QgeConfigWeightsWidget ;
class QgeNode ;

/**
@author Nestor Aguirre
*/
class QgeConfigDialogNode : public QgeConfigDialog{
	public:
		QgeConfigDialogNode( QgeNode* qgenode, QStringList types, QWidget* parent = 0 );
		~QgeConfigDialogNode();
